...
void ReactBackbone = require('react.backbone');
  ...
  return (
    <div className="row">
      <div className="row">
        ...
        <span style="text-color: grey; float: right">
  ...
  render: function() {
    ...
    return (
      <div className={isHomeActive ? "p-strip--light" : ""}>
        <div class="row">
          <div class="col-11">
            <form action="/search" class="p-search">
              <input class="p-search__field" placeholder="Search" maxlength="255" name="q" value={model.get('query')}>
              <button type="submit" class="p-search__btn">
                <svg
